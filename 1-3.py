...
# Returns the best-fit key for a given ciphertext
# (key, plaintext, score (smaller is better))
def find_best_key(ciphertext):
    cipherbytes = decode_hex_string(cypherbytes)
    ...
    return (min_idx, result, min(scores))
